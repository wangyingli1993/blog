...
<head>
    ...
    <script type="text/javascript">
        ...
        function refreshSystemCache() {
            $.post("${blog}/admin/system/refreshSystemCache.do", {}, function (result) {
                if (result.success) {
        ...
        function logout() {
            $.messager.confirm("系统提示", "您确定要退出系统吗？", function (r) {
                if (r) {
                    window.location.href = "${blog}/admin/blogger/logout.do";
                }
            });
        }
    </script>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
            <a href="javascript:openTab('写博客','blog/edit.do','icon-writeblog')" class="easyui-linkbutton"
...
<div region="south" style="height: 25px;padding: 5px" align="center">
    Copyright © 2016-2017 王颖利的SSM博客系统 版权所有
</div>
...
<div id="dlg-buttons">
    <div>
        ...
        <a href="javascript:closePasswordModifyDialog()" class="easyui-linkbutton" iconCls="icon-cancel"
           plain="true">关闭</a>
    </div>
</div>
</body>
